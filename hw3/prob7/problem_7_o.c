 ...
 *When all the threads have finished, another check will be execute to make sure
 *NO value other 0 or 1 is in the queue. (If mutual exclusion is violated, 
 *there is likely a value that bigger than 1 in the queue).
 */
...
volatile unsigned int enque_v = 0;   /*Value to be put to the queue*/
